...
export class DishdetailComponent implements OnInit {
  ...
  ngOnInit() {                                            //inside this function grabbing of data take place
    ...
    this.dishservice.getDish(id).subscribe((dish)=>this.dish = dish);        // subscribe takes a call back function as a parameter and will be called when the observable is called seccesfuly
  }
